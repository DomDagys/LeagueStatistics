...
class MatchHistoryItem extends React.Component {
  ...
  render() {
    ...
    return(
      ...
      <div>
        <div>{this.state.match.timeMin}m {this.state.match.timeSec}s</div>
        <div className={(this.state.match.teamBlue.win == "Win")?"teamWin":"teamLost"}>
          <TeamItem team={this.state.match.teamBlue}  data={this.state.data}/>
        </div>
        <div className={(this.state.match.teamRed.win == "Win")?"teamWin":"teamLost"}>
